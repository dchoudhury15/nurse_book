...
class User < ApplicationRecord
  ...
  has_many :accepted_requests, -> {where request_accepted: true}, :class_name => "Connection", :foreign_key => "sender_id", :dependent => :destroy
  ...
  has_many :friends_where_sender_accepted, :through => :accepted_requests, :source => :receiver
  ...
  has_many :timeline_posts, :through => :friends_where_sender_accepted, :source => :posts
